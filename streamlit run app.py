...
- حمل الملف**من اختر ملف Excel**    يحتوي على أوراق  (plan و Component و MRP Contor)
- **احفظ و صدّر النتائج بصيغة** Excel
📋 المتطلبات الأساسية
ملف الإدخال المطلوب:
...
**الأعمدة الأساسية في كل ورقة:**
-  **"plan"** (الخطة):
Material (المادة) - كود المنتج
Material Description (وصف المادة)
Order Type (محلى او تصدير) - E أو L
أعمدة التواريخ (Jan, Feb, etc.) - الكميات المخططة

- **"Component"**(المكونات):
Material (المادة) - كود المنتج الرئيسي
Component (المكون) - كود المادة الخام
Component Quantity (كمية المكون) - الكمية المستخدمة في المنتج
